...
window.__GB_RULES__ = {
  ...
  hideSelectors: [
    ...
    "#ALYT_privacyCookie",
    "#AMS_VYF_INLINE_TEXT",
    "#ANDISELECTORonFocusMessageText",
    ...
    "#AdsFloating_divFloating",
    "#Adv2",
    "#AeroparkVerona_cookie_advice",
    "#AiraGdprDialog",
    ...
    "#Allpopup_PW0",
    "#AltBlocked",
    "#Amzn_IE_Article_Amazon_RHS_BTM",
    "#Amzn_IE_Article_Amazon_RHS_TOP",
    "#AndroidMobileAppBanner",
    "#AppBanner",
    "#ArchivedArticleModal",
    "#ArticleRRTest_JobListings",
    "#AvisoCookies",
    "#AvisoCookieslaw",
    "#BBStoreLead",
    "#BBStoreW",
    ...
    "#Banner_cookie_1",
    "#BetaBarCtr",
    "#BodyPlaceholder_ClaimPanel > .labelPara",
    "#BodyPlaceholder_ClaimPanel > h1",
    "#BodyPlaceholder_SuccessfulClaimPanel",
    "#BookmarkList",
    ...
    "#CP_Layer",
    "#CQ",
    "#CVLR_AdvPrivacy, #CVLR_AdvPrivacy + table",
    "#CWCookie",
    "#Cam4DialogContainer",
    "#CancelYurtdisi",
    "#CancelYurtdisiContent",
    "#CkC",
    "#Cntnr6",
    "#CokCon",
    "#Column-3ad300",
    ...
    "#ConsentBanner",
    "#ConsentLayerWrapper",
    "#Content-LpsContentContainer",
    "#ContentPane46",
    "#Contents > section > .UtilityBar",
    "#Controcampus_cookie_advice",
    "#CoockiesPage",
    "#CookieAcceptLayer",
    "#CookieAcceptSubLayout1_cookiesmessageshown",
    ...
    "#CookieWall",
    "#Cookies",
    "#CookiesInfos, #CookiesInfosPrefix",
    "#CookiesValid",
    "#CornerPromotionDiv",
    "#Counters",
    "#CoverPop-content",
    ...
    "#DO_CC_PANEL",
    "#DSE",
    "#Daily-Ticket-newsletter-promo-8U",
    "#DailySubscriber",
    "#Datenschutzhinweis",
    "#DeltaPageStatusBar",
    "#Disclaimer",
